...
public class Constants {
    ...
    public static final int     DEFAULT_WARMUP                     = 1 * 60 * 1000;
    ...
    public static final String PING_SERVICE_NAME                   = "com.youzan.service.test";

    public static final String NOVA_REQUEST_TYPE                   = "_nova_request_type_";

    public static final String NOVA_DEFAULT_VERSION                = null;

    public static final String NOVA_PROTOCOL                        = "nova";

    public final static String NOVA_RELY_MODULES                    = "application.nova.rely.modules";

    /**haunt 无需注册消息*/
    public static final String UNREGISTER_CONSUMER                  = "consumer";

    public static final String ETCD_NODE_NORMAL_STATUS              = "1";

    public static final String NOAVA_GENERIC_SERVICE                = "com.youzan.nova.framework.generic.service.GenericService";

    public static final String NOVA_GENERIC_APPLICATION_KEY          = "nova_generic_application";

    public static final String TPS_REJECT                            = "reject";
}
